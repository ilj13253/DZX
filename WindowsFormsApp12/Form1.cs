...
/*
  Здравствуйте, Когда будет вообще занятия у нас должно быть сетевая программирования так ещё понимаете мы 
  платим деньги не за что! Давайте как-то исправимся лучше давайте снова Фарида позавём так ещё у нас мало 
  занятия до этого цылый месяц не было заняти
 */